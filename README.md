...
Supports a very high number of iterations with optimal processing speed to use higher image resolutions
A simple program with minimal complexity that allows optimal use of Just-In-Time (JIT) compilation
