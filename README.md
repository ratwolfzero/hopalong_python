...
- direct mapping of the sequentially generated floating point values ​​in continuous space to a discrete image grid, while tracking of the pixel hit count to represent the density map, in the second pass.
