...
- numpy *  
- numba * 
(As of October 26, 2024, Numba only supports Python versions up to 12.7. Versions 13.x are currently not supported)
- math *
...
--> (x<sub>3</sub> , y<sub>3</sub>) = (0 , 0), completing the cycle
