...
Remark: The hopalong_advanced_doc.py file in the documantation folder is the same as hopalong_advanced but with DocString documentation/comments used as a basis to create the HTML documentation with pdoc. Open the HTML file with your preferred application.
