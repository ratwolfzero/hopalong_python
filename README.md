...
- The density heatmap matrix uses raw hit counts, while the histogram density matrix represents normalized density values. Both are scaled by Matplotlib's Colormap to fit within its color space.
