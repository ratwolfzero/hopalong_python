...
*According to my current research, this applies both to mapping floating point values ​​to a discrete image and to directly processing floating point values  
​​with a true probability density function (PDF) using SciPy Kernel Density Estimation (KDE) or the faster Numpy histogram with density = True.
