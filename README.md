...
- TThe density heatmap matrix contains the raw data of the hit counts, while the histogram density matrix represents normalized density values. Both are scaled by Matplotlib's colormap to match the color space.
