...
@jit is used to accelerate the iterative calculation loop for the fractal. As @jit is not compatible with matplotlib the function hopalong has been splitted in the calculation and plotting part. 
