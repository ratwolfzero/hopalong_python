...
- Lossy Integer Conversion and Density Representation:  
  ...
  Note: The pixel hits occupie only a subset of the total available image pixels, but with some pixels hit multiple times, the total number of hits across all pixels matches the number of iterations.
