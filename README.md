...
It also seems that these "high density cycle points" lie at the boundaries of the attractor extents. So If you want to experiment with this, it is recommend that you reduce the total number of pixels by reducing the image resolution (e.g. 100x100) in order to achieve a better visual representation of the corresponding pixels.
