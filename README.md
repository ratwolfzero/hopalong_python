...
The code of the `Basic Version` is prepered for both 2D and 3D, just comment out the corresponding "render_trajectory_image" function.  
...
You can use / experiment `ax.contourf3D` or `ax.contour3D`
